...
use TechiePress\ElementorWidgets\Widgets\Url_Embed; 
use TechiePress\ElementorWidgets\Widgets\Bmi; 
    ;
...
final class TechiePressElementorWidgets {
    ...
    public function init_widgets() {
        ...
        require_once __DIR__ . '/widgets/Bmi-widget.php';

        // Register widget with elementor.
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Url_Embed() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Bmi() );
    ...
    public function create_new_category($elementor_manager){
        $elementor_manager->add_category(
            'G-next' , 
            [
                'title' => __('G-next' , 'techiepress-elementor-widgets'),
                'icon' => 'fa fa-plug'
            ]
        );
    }
